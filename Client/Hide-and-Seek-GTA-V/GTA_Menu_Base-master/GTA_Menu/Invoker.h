...
static void SET_PLAYER_WANTED_LEVEL(Player player, int wantedLevel, BOOL p1) { invoke<Void>(0xB7A0914B, player, wantedLevel, p1); } // 0xB7A0914B
...
static void REPORT_CRIME(Player player, int crimeType, int wantedLvlTresh) { invoke<Void>(0xD8EB3A44, player, crimeType, wantedLvlTresh); } // 0xD8EB3A44
...
static int GET_TIME_SINCE_PLAYER_HIT_VEHICLE(Player player) { return invoke<Any>(0x6E9B8B9E, player); } // 0x6E9B8B9E
static int GET_TIME_SINCE_PLAYER_HIT_PED(Player player) { return invoke<Any>(0xB6209195, player); } // 0xB6209195
...
static BOOL IS_PLAYER_ONLINE_B() { return invoke<BOOL>(0x9FAB6729); } // 0x9FAB6729
...
static BOOL GET_PLAYER_INVINCIBLE(Player player) { return invoke<BOOL>(0x680C90EE, player); } // 0x680C90EE
...
static void GIVE_PLAYER_RAGDOLL_CONTROL(Ped ped, BOOL toggle) { invoke<Void>(0xC7B4D7AC, ped, toggle); } // 0xC7B4D7AC
...
static Vector3 GET_ENTITY_ROTATION(Entity entity, Any p1) { return invoke<Vector3>(0x8FF45B04, entity, p1); } // 0x8FF45B04
...
static void DETACH_ENTITY(Entity entity, BOOL p1, BOOL collision) { invoke<Void>(0xC8EFCB41, entity, p1, collision); } // 0xC8EFCB41
...
static void SET_ENTITY_AS_MISSION_ENTITY(Entity entity, BOOL p1, BOOL byThisScript) { invoke<Void>(0x5D1F9E0F, entity, p1, byThisScript); } // 0x5D1F9E0F
...
static void SET_ENTITY_COORDS(Entity entity, float X, float Y, float Z, BOOL XAxes, BOOL YAxes, BOOL ZAxes, BOOL clearArea) { invoke<Void>(0xDF70B41B, entity, X, Y, Z, XAxes, YAxes, ZAxes, clearArea); } // 0xDF70B41B
static void _SET_ENTITY_COORDS_2(Entity entity, float X, float Y, float Z, BOOL XAxes, BOOL YAxes, BOOL ZAxes, BOOL clearArea) { invoke<Void>(0x749B282E, entity, X, Y, Z, XAxes, YAxes, ZAxes, clearArea); } // 0x749B282E
...
static void SET_ENTITY_VISIBLE(Entity entity, BOOL toggle, BOOL unk) { invoke<Void>(0xD043E8E1, entity, toggle, unk); } // 0xD043E8E1
...
static void SET_ENTITY_RENDER_SCORCHED(Entity entity, BOOL toggle) { invoke<Void>(0xAAC9317B, entity, toggle); } // 0xAAC9317B
...
static int GET_PED_MONEY(Ped ped) { return invoke<int>(0xEB3C4C7E, ped); } // 0xEB3C4C7E
...
static void APPLY_DAMAGE_TO_PED(Ped pedHandle, int damageAmount, BOOL p2) { invoke<Void>(0x4DC27FCF, pedHandle, damageAmount, p2); } // 0x4DC27FCF
...
static void SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(Ped PedHandle, BOOL toggle) { invoke<Void>(0x8A251612, PedHandle, toggle); } // 0x8A251612
...
static BOOL IS_PED_SWIMMING(Ped ped) { return invoke<BOOL>(0x7AB43DB8, ped); } // 0x7AB43DB8
static BOOL IS_PED_SWIMMING_UNDER_WATER(Ped ped) { return invoke<BOOL>(0x0E8D524F, ped); } // 0x0E8D524F
...
static void SET_PED_MOVEMENT_CLIPSET(Ped ped, char *clipSet, Any p2) { invoke<Void>(0xA817CDEB, ped, clipSet, p2); } // 0xA817CDEB
...
static void SET_PED_CONFIG_FLAG(Ped ped, int flagId, BOOL b00l) { invoke<Void>(0x9CFBE10D, ped, flagId, b00l); } // 0x9CFBE10D
...
static void SET_PED_CAN_EVASIVE_DIVE(Ped ped, BOOL toggle) { invoke<Void>(0x542FEB4D, ped, toggle); } // 0x542FEB4D
...
static void SET_PED_ENVEFF_SCALE(Ped ped, float value) { invoke<Void>(0xFC1CFC27, ped, value); } // 0xFC1CFC27
...
static int CREATE_SYNCHRONIZED_SCENE(float x, float y, float z, float roll, float pitch, float yaw, int p6) { return invoke<int>(0xFFDDF8FA, x, y, z, roll, pitch, yaw, p6); } // 0xFFDDF8FA
...
static void _SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(Any sceneID, BOOL p1) { invoke<Void>(0x2DE48DA1, sceneID, p1); } // 0x2DE48DA1
static Any _0x72CF2514(Any p0) { return invoke<Any>(0x72CF2514, p0); } // 0x72CF2514
static void ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(int sceneID, Entity entity, int boneIndex) { invoke<Void>(0xE9BA6189, sceneID, entity, boneIndex); } // 0xE9BA6189
...
static int GET_PED_NEARBY_PEDS(Ped PedHandle, int* sizeAndPeds, int ignore) { return invoke<int>(0x4D3325F4, PedHandle, sizeAndPeds, ignore); } // 0x4D3325F4
...
static BOOL IS_VEHICLE_MODEL(Vehicle vehicle, Hash hash) { return invoke<BOOL>(0x013B10B6, vehicle, hash); } // 0x013B10B6
...
static BOOL IS_VEHICLE_TYRE_BURST(Vehicle veh, int wheelID, BOOL completely) { return invoke<BOOL>(0x48C80210, veh, wheelID, completely); } // 0x48C80210
...
static void SET_VEHICLE_TYRES_CAN_BURST(Vehicle vehicle, BOOL toggle) { invoke<Void>(0xA198DB54, vehicle, toggle); } // 0xA198DB54
...
static void SET_TRAIN_SPEED(Vehicle train, float speed) { invoke<Void>(0xDFC35E4D, train, speed); } // 0xDFC35E4D
static void SET_TRAIN_CRUISE_SPEED(Vehicle train, float speed) { invoke<Void>(0xB507F51D, train, speed); } // 0xB507F51D
...
static Vehicle GET_CLOSEST_VEHICLE(float x, float y, float z, float radius, Hash hash, int flags) { return invoke<Vehicle>(0xD7E26B2C, x, y, z, radius, hash, flags); } // 0xD7E26B2C
...
static void SET_MISSION_TRAIN_COORDS(Vehicle train, float x, float y, float z) { invoke<Void>(0xD6D70803, train, x, y, z); } // 0xD6D70803
...
static void SET_RENDER_TRAIN_AS_DERAILED(Vehicle train, BOOL toggle) { invoke<Void>(0x899D9092, train, toggle); } // 0x899D9092
static void SET_VEHICLE_EXTRA_COLOURS(Vehicle veh, int pearlescentColor, int wheelColor) { invoke<Void>(0x515DB2A0, veh, pearlescentColor, wheelColor); } // 0x515DB2A0
...
static void SET_VEHICLE_MOD_COLOR_1(Vehicle vehicle, int paintType, int color, int p3) { invoke<Void>(0xCBE9A54D, vehicle, paintType, color, p3); } // 0xCBE9A54D
...
static void TOGGLE_VEHICLE_MOD(Vehicle vehicle, int ModType, BOOL Toggle) { invoke<Void>(0xD095F811, vehicle, ModType, Toggle); } // 0xD095F811
...
static void SET_VEHICLE_IS_WANTED(Vehicle vehicle, BOOL state) { invoke<Void>(0xDAA388E8, vehicle, state); } // 0xDAA388E8
...
static void DETACH_VEHICLE_FROM_CARGOBOB(Vehicle vehicle, Vehicle cargobob) { invoke<Void>(0x83D3D331, vehicle, cargobob); } // 0x83D3D331
...
static Vehicle GET_VEHICLE_ATTACHED_TO_CARGOBOB(Vehicle cargobob) { return invoke<Vehicle>(0x301A1D24, cargobob); } // 0x301A1D24
...
static void _ENABLE_CARGOBOB_HOOK(Vehicle cargobob, int state) { invoke<Void>(0x4D3C9A99, cargobob, state); } // 0x4D3C9A99
static void _CARGOBOB_MAGNET_GRAB_VEHICLE(Vehicle cargobob, BOOL toggle) { invoke<Void>(0xF57066DA, cargobob, toggle); } // 0xF57066DA
...
//namespace OBJECT
static Object CREATE_OBJECT(Hash ObjectHash, float x, float y, float z, BOOL networkHandle, BOOL createHandle, BOOL dynamic) { return invoke<Object>(0x2F7AA05C, ObjectHash, x, y, z, networkHandle, createHandle, dynamic); } // 0x2F7AA05C
...
static Pickup CREATE_AMBIENT_PICKUP(Hash AmbientHash, float XCoord, float YCoord, float ZCoord, int p4, int amount, Hash modelHash, BOOL p7, BOOL p8) { return invoke<Pickup>(0x17B99CE7, AmbientHash, XCoord, YCoord, ZCoord, p4, amount, modelHash, p7, p8); } // 0x17B99CE7
...
//namespace AI
static void TASK_PAUSE(Ped ped, int ms) { invoke<Void>(0x17A64668, ped, ms); } // 0x17A64668
...
static void TASK_HANDS_UP(Ped ped, int time, Ped facingPed, int p3, BOOL p4) { invoke<Void>(0x8DCC19C5, ped, time, facingPed, p3, p4); } // 0x8DCC19C5
...
static void TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Ped ped, Entity entity, float offsetX, float offsetY, float offsetZ, float movementSpeed, int timeout, float stoppingRange, BOOL persistFollowing) { invoke<Void>(0x2DF5A6AC, ped, entity, offsetX, offsetY, offsetZ, movementSpeed, timeout, stoppingRange, persistFollowing); } // 0x2DF5A6AC
...
static void TASK_FOLLOW_NAV_MESH_TO_COORD(Ped ped, float x, float y, float z, float speed, int timeout, float stoppingRange, BOOL persistFollowing, float unk) { invoke<Void>(0xFE4A10D9, ped, x, y, z, speed, timeout, stoppingRange, persistFollowing, unk); } // 0xFE4A10D9
...
static void STOP_ANIM_TASK(Ped ped, char *animDict, char *animName, float p3) { invoke<Void>(0x2B520A57, ped, animDict, animName, p3); } // 0x2B520A57
...
static void TASK_SYNCHRONIZED_SCENE(Ped ped, int scene, char* animDictionary, char* animationName, float speed, float speedMultiplier, int duration, int flag, float playbackRate, Any p9) { invoke<Void>(0x4F217E7B, ped, scene, animDictionary, animationName, speed, speedMultiplier, duration, flag, playbackRate, p9); } // 0x4F217E7B
...
static void _CREATE_LIGHTNING_THUNDER() { invoke<Void>(0xDF38165E); } // 0xDF38165E
...
static Hash GET_HASH_KEY(const char* ToHash) { return invoke<int>(0x98EFF6F1, ToHash); } // 0x98EFF6F1
...
static void CLEAR_AREA(float x, float y, float z, float radius, BOOL p4, BOOL ignoreCars, BOOL ignoreObjects, BOOL p7) { invoke<Void>(0x854E9AB8, x, y, z, radius, p4, ignoreCars, ignoreObjects, p7); } // 0x854E9AB8
...
static void SHOOT_SINGLE_BULLET_BETWEEN_COORDS(float StartPositionX, float StartPositionY, float StartPositionZ, float HitPositionX, float HitPositionY, float HitPositionZ, int damage, BOOL p7, Hash WeaponHash, Ped PedHandle, BOOL isAudible, BOOL isInvisible, float Speed) { invoke<Void>(0xCB7415AC, StartPositionX, StartPositionY, StartPositionZ, HitPositionX, HitPositionY, HitPositionZ, damage, p7, WeaponHash, PedHandle, isAudible, isInvisible, Speed); } // 0xCB7415AC
...
static BOOL REQUEST_MISSION_AUDIO_BANK(char* p0, BOOL p1) { return invoke<BOOL>(0x916E37CA, p0, p1); } // 0x916E37CA
static BOOL REQUEST_AMBIENT_AUDIO_BANK(char* p0, BOOL p1) { return invoke<BOOL>(0x23C88BC7, p0, p1); } // 0x23C88BC7
...
static void PLAY_SOUND_FROM_ENTITY(int soundId, char* audioName, Entity entity, char* audioRef, BOOL p4, Any p5) { invoke<Void>(0x95AE00F8, soundId, audioName, entity, audioRef, p4, p5); } // 0x95AE00F8
...
static void SET_MOBILE_PHONE_RADIO_STATE(BOOL state) { invoke<Void>(0xE1E0ED34, state); } // 0xE1E0ED34
...
static void OVERRIDE_VEH_HORN(Vehicle veh, BOOL mute, int p2) { invoke<Void>(0x2ACAB783, veh, mute, p2); } // 0x2ACAB783
...
static BOOL START_AUDIO_SCENE(char* sceneName) { return invoke<BOOL>(0xE48D757B, sceneName); } // 0xE48D757B
...
static void SET_AUDIO_FLAG(char* flagName, BOOL toggle) { invoke<Void>(0x1C09C9E0, flagName, toggle); } // 0x1C09C9E0
...
static Cam CREATE_CAM_WITH_PARAMS(char* camName, float posX, float posY, float posZ, float rotX, float rotY, float rotZ, float fov, BOOL p8, int p9) { return invoke<Cam>(0x23B02F15, camName, posX, posY, posZ, rotX, rotY, rotZ, fov, p8, p9); } // 0x23B02F15
...
static void SET_CAM_FOV(char* camName, float FovValue) { invoke<Void>(0xD3D5D74F, camName, FovValue); } // 0xD3D5D74F
...
static Vector3 GET_GAMEPLAY_CAM_ROT(int p0) { return invoke<Vector3>(0x13A010B5, p0); } // 0x13A010B5
...
static void GIVE_DELAYED_WEAPON_TO_PED(Ped ped, Hash weaponHash, int time, BOOL equipNow) { invoke<Void>(0x5868D20D, ped, weaponHash, time, equipNow); } // 0x5868D20D
...
static void SET_PED_CURRENT_WEAPON_VISIBLE(Ped ped, BOOL visible, BOOL deselectWeapon, BOOL p3, BOOL p4) { invoke<Void>(0x00BECD77, ped, visible, deselectWeapon, p3, p4); } // 0x00BECD77
...
static BOOL GET_PED_LAST_WEAPON_IMPACT_COORD(Ped ped, float* Coords) { return invoke<BOOL>(0x9B266079, ped, Coords); } // 0x9B266079
...
static void REQUEST_ANIM_DICT(char* AnimDict) { invoke<Void>(0xDCA96950, AnimDict); } // 0xDCA96950
static BOOL HAS_ANIM_DICT_LOADED(char* AnimDict) { return invoke<BOOL>(0x05E6763C, AnimDict); } // 0x05E6763C
...
static BOOL HAS_ANIM_SET_LOADED(char *animSet) { return invoke<BOOL>(0x4FFF397D, animSet); } // 0x4FFF397D
...
static void BEGIN_TEXT_COMMAND_PRINT(char* entry) { invoke<Void>(0xF42C43C7, entry); } // 0xF42C43C7
static void END_TEXT_COMMAND_PRINT(int duration, BOOL drawImmediately) { invoke<Void>(0x38F82261, duration, drawImmediately); } // 0x38F82261
...
static char *GET_STREET_NAME_FROM_HASH_KEY(Hash hash) { return invoke<char*>(0x1E8E310C, hash); } // 0x1E8E310C
...
static void _SET_HUD_COLOUR(int hudColorIndex, int r, int g, int b, int a) { invoke<Void>(0xF6E7E92B, hudColorIndex, r, g, b, a); } // 0xF6E7E92B
...
static void SET_TEXT_FONT(int fontType) { invoke<Void>(0x80BC530D, fontType); } // 0x80BC530D
...
static void REMOVE_BLIP(Blip* BlipID) { invoke<Void>(0xD8C3C1CD, BlipID); } // 0xD8C3C1CD
...
static BOOL IS_HUD_COMPONENT_ACTIVE(int id) { return invoke<BOOL>(0x6214631F, id); } // 0x6214631F
static BOOL IS_SCRIPTED_HUD_COMPONENT_ACTIVE(int id) { return invoke<BOOL>(0x2B86F382, id); } // 0x2B86F382
...
static void DRAW_MARKER(int type, float x, float y, float z, float dirX, float dirY, float dirZ, float rotX, float rotY, float rotZ, float scaleX, float scaleY, float scaleZ, int colorR, int colorG, int colorB, int alpha, BOOL bobUpAndDown, BOOL faceCamera, int p19, BOOL rotate, char* textureDict, char* textureName, BOOL drawOnEnts) { invoke<Void>(0x48D84A02, type, x, y, z, dirX, dirY, dirZ, rotX, rotY, rotZ, scaleX, scaleY, scaleZ, colorR, colorG, colorB, alpha, bobUpAndDown, faceCamera, p19, rotate, textureDict, textureName, drawOnEnts); }
...
static void _SET_2D_LAYER(int layer) { invoke<Void>(0xADF81D24, layer); } // 0xADF81D24
...
static float GET_SAFE_ZONE_SIZE() { return invoke<float>(0x3F0D1A6F); } // 0x3F0D1A6F
static void DRAW_SPRITE(char *textureDict, char *textureName, float posX, float posY, float scaleX, float scaleY, float heading, int red, int green, int blue, int alpha) { invoke<Void>(0x1FEC16B0, textureDict, textureName, posX, posY, scaleX, scaleY, heading, red, green, blue, alpha); } // 0x1FEC16B0
...
static BOOL _WORLD3D_TO_SCREEN2D(float worldX, float worldY, float worldZ, float* screenX, float* screenY) { return invoke<BOOL>(0x1F950E4B, worldX, worldY, worldZ, screenX, screenY); } // 0x1F950E4B
...
static BOOL _START_PARTICLE_FX_NON_LOOPED_AT_COORD_2(char* effectName, float xCoord, float yCoord, float zCoord, float xRot, float yRot, float zRot, float scale, BOOL xAxis, BOOL yAxis, BOOL zAxis) { return invoke<BOOL>(0x633F8C48, effectName, xCoord, yCoord, zCoord, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis); } // 0x633F8C48
...
static BOOL _START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2(char *effectName, Ped ped, float offsetX, float offsetY, float offsetZ, float rotX, float rotY, float rotZ, int boneIndex, float scale, BOOL axisX, BOOL axisY, BOOL axisZ) { return invoke<BOOL>(0x161780C1, effectName, ped, offsetX, offsetY, offsetZ, rotX, rotY, rotZ, boneIndex, scale, axisX, axisY, axisZ); } // 0x161780C1
static BOOL START_PARTICLE_FX_NON_LOOPED_ON_ENTITY(char *effectName, Entity entity, float offsetX, float offsetY, float offsetZ, float rotX, float rotY, float rotZ, float scale, BOOL axisX, BOOL axisY, BOOL axisZ) { return invoke<BOOL>(0x9604DAD4, effectName, entity, offsetX, offsetY, offsetZ, rotX, rotY, rotZ, scale, axisX, axisY, axisZ); } // 0x9604DAD4
static BOOL _START_PARTICLE_FX_NON_LOOPED_ON_ENTITY_2(char *effectName, Entity entity, float offsetX, float offsetY, float offsetZ, float rotX, float rotY, float rotZ, float scale, BOOL axisX, BOOL axisY, BOOL axisZ) { return invoke<BOOL>(0x469A2B4A, effectName, entity, offsetX, offsetY, offsetZ, rotX, rotY, rotZ, scale, axisX, axisY, axisZ); } // 0x469A2B4A
...
static Any START_PARTICLE_FX_LOOPED_ON_PED_BONE(char *effectName, Entity entity, float xOffset, float yOffset, float zOffset, float xRot, float yRot, float zRot, int boneIndex, float scale, BOOL xAxis, BOOL yAxis, BOOL zAxis) { return invoke<Any>(0xF8FC196F, effectName, entity, xOffset, yOffset, zOffset, xRot, yRot, zRot, boneIndex, scale, xAxis, yAxis, zAxis); } // 0xF8FC196F
static Any _START_PARTICLE_FX_LOOPED_ON_ENTITY_BONE_2(char *effectName, Entity entity, float xOffset, float yOffset, float zOffset, float xRot, float yRot, float zRot, int boneIndex, float scale, BOOL xAxis, BOOL yAxis, BOOL zAxis) { return invoke<Any>(0xF478EFCF, effectName, entity, xOffset, yOffset, zOffset, xRot, yRot, zRot, boneIndex, scale, xAxis, yAxis, zAxis); } //0xF478EFCF
...
static int _START_PARTICLE_FX_LOOPED_ON_ENTITY_2(char *effectName, Entity entity, float offsetX, float offsetY, float offsetZ, float rotX, float rotY, float rotZ, float scale, BOOL axisX, BOOL axisY, BOOL axisZ) { return invoke<int>(0x110752B2, effectName, entity, offsetX, offsetY, offsetZ, rotX, rotY, rotZ, scale, axisX, axisY, axisZ); } // 0x110752B2
...
static void SET_PARTICLE_FX_LOOPED_ALPHA(int ptfxHandle, float alpha) { invoke<Void>(0x5ED49BE1, ptfxHandle, alpha); } // 0x5ED49BE1
...
static void SET_TRANSITION_TIMECYCLE_MODIFIER(char *CycleType, float transition) { invoke<Void>(0xBB2BA72A, CycleType, transition); } // 0xBB2BA72A
...
static void DRAW_SCALEFORM_MOVIE_FULLSCREEN(int scaleform, int red, int green, int blue, int alpha, BOOL unk) { invoke<Void>(0x7B48E696, scaleform, red, green, blue, alpha, unk); } // 0x7B48E696
...
static void _BEGIN_TEXT_COMPONENT(char* componentType) { invoke<Void>(0x3AC9CB55, componentType); } // 0x3AC9CB55
...
static void DISABLE_CONTROL_ACTION(int Index, int Control, bool disable) { invoke<Void>(0x3800C0DC, Index, Control, disable); } // 0x3800C0DC
static void ENABLE_CONTROL_ACTION(int Index, int Control, bool enable) { invoke<Void>(0xD2753551, Index, Control, enable); } // 0xD2753551
...
static void ADD_OWNED_EXPLOSION(Ped PedHandle, float X, float Y, float Z, int ExlosionType, float ExplosionRadius, BOOL IsAudible, BOOL IsVisible, float CamerShake) { invoke<Void>(0x27EE0D67, PedHandle, X, Y, Z, ExlosionType, ExplosionRadius, IsAudible, IsVisible, CamerShake); } // 0x27EE0D67
...
//namespace ROPE
static Object ADD_ROPE(float position_x, float position_y, float position_z, float angle_x, float angle_y, float angle_z, float length, int type, float max_length, float min_length, float p10, BOOL p11, BOOL p12, BOOL rigid, float p14, BOOL breakWhenShot, int *p16) { return invoke<Object>(0xA592EC74, position_x, position_y, position_z, angle_x, angle_y, angle_z, length, type, max_length, min_length, p10, p11, p12, rigid, p14, breakWhenShot, p16); } // 0xA592EC74
...
static void ATTACH_ENTITIES_TO_ROPE(Object rope, Entity ent1, Entity ent2, float ent1_x, float ent1_y, float ent1_z, float ent2_x, float ent2_y, float ent2_z, float length, BOOL p10, BOOL p11, Any *p12, Any *p13) { invoke<Void>(0x7508668F, rope, ent1, ent2, ent1_x, ent1_y, ent1_z, ent2_x, ent2_y, ent2_z, length, p10, p11, p12, p13); } // 0x7508668F
static void ATTACH_ROPE_TO_ENTITY(Object rope, Entity entity, float x, float y, float z, BOOL p5) { invoke<Void>(0xB25D9536, rope, entity, x, y, z, p5); } // 0xB25D9536
static void DETACH_ROPE_FROM_ENTITY(Object rope, Entity entity) { invoke<Void>(0x3E720BEE, rope, entity); } // 0x3E720BEE
...
static float _GET_WAVES_INTENSITY() { return invoke<float>(0xBD0A67FB); } // 0xBD0A67FB
static void _RESET_WAVES_INTENSITY() { invoke<Void>(0x4AD23212); } // 0x4AD23212
...
static Any NETWORK_SEND_TEXT_MESSAGE(char *message, int networkHandle) { return invoke<Any>(0xAFFEA720, message, networkHandle); } // 0xAFFEA720
...
static Player _NETWORK_GET_PED_PLAYER(Ped ped) { return invoke<Player>(0x40DBF464, ped); } // 0x40DBF464
...
static int NETWORK_GET_HOST_OF_SCRIPT(char *scriptName, int p1, Any p2) { return invoke<Any>(0x9C95D0BB, scriptName, p1, p2); } // 0x9C95D0BB
...
static void NETWORK_HANDLE_FROM_PLAYER(Ped PedHandle, int FreeMemPointer, int bufferSize) { invoke<Void>(0xD3498917, PedHandle, FreeMemPointer, bufferSize); } // 0xD3498917
static void NETWORK_HANDLE_FROM_PLAYER_TEST(Player player, int *networkHandle, int bufferSize) { invoke<Void>(0xD3498917, player, networkHandle, bufferSize); } // 0xD3498917
...
static BOOL NETWORK_IS_HANDLE_VALID(int* networkHandle, int bufferSize) { return invoke<BOOL>(0xF0996C6E, networkHandle, bufferSize); } // 0xF0996C6E
...
static void NETWORK_SET_OVERRIDE_SPECTATOR_MODE(BOOL toggle) { invoke<Void>(0xA0FD42D3, toggle); } // 0xA0FD42D3
...
static void _NETWORK_SET_ENTITY_VISIBLE_TO_NETWORK(Entity entity, BOOL toggle) { invoke<Void>(0x09CBC4B0, entity, toggle); } // 0x09CBC4B0
...
static int NETWORK_CREATE_SYNCHRONISED_SCENE(float x, float y, float z, float xRot, float yRot, float zRot, int p6, int p7, int p8, float p9, float p10, float p11) { return invoke<netScene>(0xB06FE3FE, x, y, z, xRot, yRot, zRot, p6, p7, p8, p9, p10, p11); } // 0xB06FE3FE
static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Ped ped, int netScene, char *animDict, char *animName, float speed, float speedMultiplier, int duration, int flag, float playbackRate, Any p9) { invoke<Void>(0xB386713E, ped, netScene, animDict, animName, speed, speedMultiplier, duration, flag, playbackRate, p9); } // 0xB386713E
...
static void NETWORK_START_SYNCHRONISED_SCENE(int netScene) { invoke<Void>(0xA9DFDC40, netScene); } // 0xA9DFDC40
static void NETWORK_STOP_SYNCHRONISED_SCENE(int netScene) { invoke<Void>(0x97B1CDF6, netScene); } // 0x97B1CDF6
...
static void NETWORK_EARN_FROM_BOUNTY(int amount, int* playerHandle, Any* p2, Any p3) { invoke<Void>(0x127F2DAE, amount, playerHandle, p2, p3); } // 0x127F2DAE
...
static void NETWORK_BUY_BOUNTY(int amount, Player victim, BOOL p2, BOOL p3) { invoke<Void>(0xCB89CBE0, amount, victim, p2, p3); } // 0xCB89CBE0
